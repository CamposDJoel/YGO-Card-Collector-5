    ...
    public partial class CollectorBinderMode : Form
    {
        ...
        private void LoadPage()
        {
            ...
            void UpdatePageBanners()
            {
                ...
                if (_MasterCardViewMode)
                {
                    GroupCardView.Text = string.Format("PAGE: {0}/{1} | {2} | Cards: {2}", _CurrentCardPage, lastPage, Database.CardGroupToString(_CurrentCardGroup), _CurrentMasterCardList.Count);
                }
                else
                {

...
namespace YGO_Card_Collector_5
{
    ...
    {
        #region Constructors
        public DeckBuilder(int deckId, DeckSelectorForm deckSelectorFormRef)
        {
            _deckSelectorFormRef = deckSelectorFormRef;
            InitializeComponent();
        ...
        #region Private Data
        private DeckSelectorForm _deckSelectorFormRef;
